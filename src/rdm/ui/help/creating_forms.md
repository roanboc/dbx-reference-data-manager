## Creating a form (Function admins)
...
**Audit columns** toggle. The app tracks *who changed what and when* through these columns
and the history; if a list needs its own business dates (for example a validity period),
define those as ordinary columns.
...
* **Settings** tab: display name, description, owner. Deleting a form is reserved to global
  administrators.
